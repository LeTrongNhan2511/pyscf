...
def kernel(mp, mo_energy=None, mo_coeff=None, eris=None, with_t2=WITH_T2,
    ...
    for it in range(niter):
        ...
        err_ab_mo = numpy.matmul(A.real.T,numpy.matmul(err_ab_ao,A))
        err_ba_mo = numpy.matmul(A.real.T,numpy.matmul(err_ba_ao,A))
        
        # Build DIIS Residual
        diis_r_a = A.real.dot(err_a_mo + 40*err_ab_mo + 40*err_ba_mo + err_b_mo).dot(A.real)
        ...
        # Build DIIS Residual
        diis_r_b = A.real.dot(err_a_mo + err_b_mo + 40*err_ab_mo + 40*err_ba_mo).dot(A.real)
...
def mom_occ_(mp, orb_init):
    ...
    '''
    print("s_a, s_b")
    print(numpy.einsum('ij,ij->j', s_b, s_b))
    print(numpy.einsum('ij,ij->j', s_a, s_a))
    '''
